...
<div class="wizard-input-section">
	...
	<h4 style="text-align: center; font-weight: bold;">Please select the training establishment</h4>
	...
	<div class="form-group">
		<div class="myRadio row justify-content-md-center" style="margin:0; padding-top: 0px">
			<div class="row" style="margin:0; margin-bottom:15px">
				<div class="col-sm-12" style="border-top:1px solid #cccddd">
					...
					<span style="margin-bottom:1px; font-size:12px; font-weight:bold">First choice: preferred training facility</span>
				</div>
			</div>
			...
			<div class="col-sm-3 text-center etablissement_11">
				...
				<span style="margin-bottom:1px; font-size:10px">Yaounde</span>	    
				</label>
			</div>
		...
		<div class="myRadio row " style="margin:0; padding-top: 5px; margin-top:5px">
			<div class="row" style="margin:0; margin-bottom:5px">
				<div class="col-sm-12" style="border-top:1px solid #cccddd">
					...
					<span style="margin-bottom:1px; font-size:12px; font-weight:bold; ">Second choice: substitute training facility, if necessary <strong style="color:red">(Not required)</strong></span><br/>	
			...
			<div class="col-sm-3 ml-sm-auto text-center etablissement_1_">
			  ...
			  <label for="etablissement_1_x">
			    <h5 class="mb-0" style="margin-top: 12px; margin-bottom:0">NOTHING</h5>	
			...
			<div class="col-sm-3 text-center etablissement_111">
				...
				<h5 class="mb-0" style="margin-top: 12px; margin-bottom:0">IFTICSUP</h5>
				<span style="margin-bottom:12px; font-size:14px">Yaounde</span>		    
				</label>
			</div>
		...
		<div class="myRadio row " style="margin:0; padding-top: 5px; margin-top:5px">
			<div class="row" style="margin:0; margin-bottom:5px">
				<div class="col-sm-12" style="border-top:1px solid #cccddd">
					<span style="margin-bottom:1px; font-size:12px; font-weight:bold; ">Third choice: substitute training facility, if required <strong style="color:red">(Not required)</strong></span><br/>	
					</span>	
				</div>
			</div>
