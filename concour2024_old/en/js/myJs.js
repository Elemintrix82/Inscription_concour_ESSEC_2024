$(document).ready(function() {
	...
	$('input:radio[name="etablissement"]').change(function () {
		if($(this).val()==='IFTICSUP'){
			...
			alert("NB : Given that you have done so deliberately, by choosing an establishment other than ESSEC, you are thereby undertaking to pay the training fees which are applied there, in the event that you succeed the competition to enter therein.");
			// $('.notaBene').show(100);
	...
	$('input:radio[name="etablissement2"]').change(function () {
		if($(this).val()==='IFTICSUP'){
			...
			var defaultRadio = document.getElementById("etablissement_1_x");
			if (confirm("NB : Given that you have done so deliberately, by choosing an establishment other than ESSEC, you are thereby undertaking to pay the training fees which are applied there, in the event that you succeed the competition to enter therein.")) {
	...
	$('input:radio[name="etablissement3"]').change(function () {
		if($(this).val()==='IFTICSUP'){
			...
			if (confirm("NB 1 : Given that you have done so deliberately, by choosing an establishment other than ESSEC, you are thereby undertaking to pay the training fees which are applied there, in the event that you succeed the competition to enter therein")) {
				console.log("You pressed OK!");
				ifticsupRadio.checked = true;
			} else {
				console.log("You pressed Cancel!");
	...
	$('input[name="worker"]').click(function() {
		if($(this).parent().find('span').text()=='Oui'){
